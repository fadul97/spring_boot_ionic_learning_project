...
import com.leonardofadul.springboot.ionic.learning.project.dto.ProductDTO;
import com.leonardofadul.springboot.ionic.learning.project.resources.utils.URL;
import com.leonardofadul.springboot.ionic.learning.project.services.ProductService;
...
public class ProductResource {
    ...
    public ResponseEntity<Page<ProductDTO>> findPage(@RequestParam(value = "name", defaultValue = "") String name,
        ...
        Page<Product> productPage = productService.search(nameDecoded, ids, page, linesPerPage, orderBy, direction);
